...
def write_param_dict():
    ...
    param_dict[EXP_NAME] = 'Measles-GHA-Test'
    ...
    # Infectivity
    vals = 9.0 + np.random.gamma(30.0, scale=0.133, size=NSIMS)
    ...
    P_CON['SIA_cover_GHA_2010'] = 0.60
    P_CON['SIA_cover_GHA_2013'] = 0.45
    P_CON['SIA_cover_GHA_2018'] = 0.10
