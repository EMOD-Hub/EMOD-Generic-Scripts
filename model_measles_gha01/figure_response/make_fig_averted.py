...
def make_fig():
    ...
    for dirname in DIRNAMES:
        ...
        arg1 = np.linspace(lxmin-dxval/2, lxmax+dxval/2, nbins+1)
        arg2 = np.linspace(ymin-dyval/2, ymax+dyval/2, nbins+1)
        (xvec, yvec) = np.meshgrid(arg1, arg2)
        ...
        cbar_handle.set_label('Cumulative Infections',
