...
DEMOG_IRS = 'InfectivityReservoirSize'

DIST_NONE = 'DISTRIBUTION_OFF'
DIST_CMPLX = 'DISTRIBUTION_COMPLEX'
DIST_CONST = 'CONSTANT_DISTRIBUTION'
DIST_UNIFR = 'UNIFORM_DISTRIBUTION'
DIST_GAMMA = 'GAMMA_DISTRIBUTION'
DIST_GAUSS = 'GAUSSIAN_DISTRIBUTION'
DIST_LOGNR = 'LOG_NORMAL_DISTRIBUTION'
