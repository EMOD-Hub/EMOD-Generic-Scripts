...
def write_param_dict():
    ...
    param_dict[EXP_NAME] = 'cVDPV2-100km-base-y13-sia2p1_LKCHAD-obr2026-ri2027'
    ...
    # RI params
    P_CON['ri_start_yr'] = 2027
    P_CON['ri_end_yr'] = 2100
    P_CON['ri_doses'] = 3
    ...
    P_CON['sia_plan_file'] = 'sia_plan_LAKECHAD_1Y2'
